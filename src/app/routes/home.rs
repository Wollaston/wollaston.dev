        ...
        <section class="dark:bg-gray-900">
            <div class="py-2 px-4 mx-auto max-w-screen-xl sm:py-4 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">"What can I help with?"</h2>
                </div>
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
                            <path d="M10 25h80v50H10Zm0 0 20-15 20 15h40" fill="#fee5b0"/>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">"Data & Document Management"</h3>
