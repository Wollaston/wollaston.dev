...
fn ProjectCard(project: Project) -> impl IntoView {
    view! {
        <div class="max-w p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href={project.path}>
                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 hover:text-blue-700 dark:text-white">{project.title}</h5>
            </a>
